...
public class AdmissionRecordController {
    ...
    public AdmissionRecordDTO getAdmissionRecordById(@PathVariable Long studentId){
        return admissionRecordService.getAdmissionRecordById(studentId);
    }

    @PostMapping
    public AdmissionRecordDTO createAdmissionRecord(@RequestBody AdmissionRecordDTO inputAdmissionRecord){
